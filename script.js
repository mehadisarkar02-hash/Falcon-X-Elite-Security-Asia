document.addEventListener('DOMContentLoaded', function () {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    /* ===============================
       Tools Card Hover Sound (Optional)
       চাইলে বাদ দিতে পারেন
    ================================ */
    const toolCards = document.querySelectorAll(".project-card");
    ...
    ================================ */
    const toolButtons = document.querySelectorAll(".project-details-btn");
